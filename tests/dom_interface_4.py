...
class DomInterface(DogPlayerInterface):
    ...
    def receive_withdrawal_notification(self):
        ...
        Implements Diagram 4: Receive Abandonment Notification.
        """
        #* Início
        print("Received withdrawal notification.")

        #* Ação: Definir estado do jogo como "abandonado pelo oponente"
        self.game.match_status = 5
        
        #* Ação: Verificar estado do jogo (implícito na definição do status acima)
        
        #* Ação: Atualizar interface
        self.refresh_ui()
        
        # Ação extra: Notificar explicitamente o usuário.
